...
public class Window extends JFrame {
	...
	private Text text;
	private JButton couper, copier, coller, enregistrer, arreter, rejouer;
	...
	private JPanel cardBienvenue(){		
		...
		JLabel texteBienvenue = new JLabel("<html><body>Bienvenue sur notre mini editeur,<br/>Version 2<br/><br/>");	//message de bienvenue
